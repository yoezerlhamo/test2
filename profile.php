                    ...
                    <hr>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0%;" onClick='savebtn()' name="save" type="submit">Save Changes</button>
                                </div>
                            </div>
                        </form>
                        <!--/tab-content-->
